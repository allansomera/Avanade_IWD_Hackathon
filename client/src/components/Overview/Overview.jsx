				...
				<div className="overview__container">
					<div className="overview__top">
						...
						<div className="overview__details">
							...
							<div className="overview__details__industry">
								...
								<p className="overview__details__industry-text">
									IT Support Services
								</p>
							</div>
					...
					<div className="overview__btm">
						...
						<p className="overview__btm-text">
							Avanade is the leading provider of innovative digital, cloud and
							advisory services, industry solutions and design-led experiences across
							the Microsoft ecosystems. Every day, our 56,000 professionals in 26
							countries make a genuine human impact for our clients, their employees
							and their customers.
						</p>
					</div>
				</div>
